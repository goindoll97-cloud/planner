...
class Stage2NavigationLinkTests(unittest.TestCase):
    def test_validation_page_links_to_registered_report_writing_page(self):
        ...
        self.assertIn('st.Page("ui/stage2_review_page.py", title="5. 보고서 작성"', app_text)
        self.assertIn('st.page_link("ui/stage2_review_page.py", label="다음: 5. 보고서 작성"', validation_text)
