...
class CompanyIntakeContractTests(unittest.TestCase):
    def test_initial_workbook_contains_company_only_final_report_facts(self):
        ...
        for expected in [
            ...
            "화학사고예방관리계획서 산업단지명",
            "화학사고예방관리계획서 제출구분",
            "화학사고예방관리계획서 공동비상대응계획 수립 여부",
            "화학사고예방관리계획서 최근 3년간 화학사고 발생 여부",
            "화학사고예방관리계획서 작성자 성명",
            "화학사고예방관리계획서 담당자 연락처",
            "화학사고예방관리계획서 담당자 이메일",
        ]:
        ...
        joined = "\n".join(str(value) for value in labels if value is not None)
        self.assertNotIn("PSM", joined)
        self.assertNotIn("CAP", joined)
    ...
    def test_workbook_parser_keeps_new_business_facts(self):
        ...
        self.assertIn("공정안전보고서 심사대상 설비명", intake.business)
        self.assertIn("화학사고예방관리계획서 담당자 이메일", intake.business)
    ...
    def test_stage2_carries_company_facts_without_inference(self):
        snapshot = {
            ...
            "business": {
                ...
                "전기계약용량(kW)": 2100,
                "공정안전보고서 사업 구분": "변경",
                "공정안전보고서 심사대상 설비명": "R-101 반응공정",
                "공정안전보고서 부지면적(㎡)": 12345,
                "공정안전보고서 주요건물(동/층/연면적)": "2동/3층/5,000㎡",
                "공정안전보고서 작성자 성명": "김안전",
                "공정안전보고서 작성자 자격": "산업안전기사",
                "공정안전보고서 총사업기간": "2026.10~2027.06",
                "공정안전보고서 착공예정일": "2026-10-15",
                "공정안전보고서 시운전기간": "2027.05~2027.06",
                "화학사고예방관리계획서 단위공장명": "제1생산공장",
                "화학사고예방관리계획서 산업단지명": "울산미포국가산업단지",
                "화학사고예방관리계획서 제출구분": "신규",
                "화학사고예방관리계획서 공동비상대응계획 수립 여부": "N",
                "화학사고예방관리계획서 유사제도 심사결과 활용 여부": "Y",
                "화학사고예방관리계획서 최근 3년간 화학사고 발생 여부": "N",
                "화학사고예방관리계획서 작성자 성명": "이환경",
                "화학사고예방관리계획서 담당자 연락처": "010-1111-2222",
                "화학사고예방관리계획서 담당자 이메일": "safe@example.com",
            },
            "documents": {},
