...
def _build_guide_sheet(wb: Workbook) -> None:
    ...
    rows = [
        ...
        ["법정 예외·특수조건", "PSM 시행령 제43조제2항 제외설비·화관법 제23조제1항 단서·고시 제9조 작성 면제 시설 등", "조건부 필수", "설비용도·인허가·운영자료", "해당없음", "모름", "제출·작성 의무 및 작성수준 결정", "05_최종판정조건·06_공정안전보고서_비고8제외수량 참고"],
    ]
...
def _build_documents_sheet(wb: Workbook) -> None:
    ...
    _style_header(ws, "A3:E3")
    rows = [
        ["공정안전보고서", "Y", "PSM 대상 판정 후", "기존 공정안전자료 재활용", "2024년 작성본 보유 가정"],
