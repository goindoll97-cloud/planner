...
MACHINERY = TableSpec(
    ...
    "동력기계를 한 줄에 하나씩 적습니다. 펌프·압축기는 처리량·토출압력·회전수, 교반기는 임펠러 반경·회전수, "
    "양중기는 양중하중·양중높이를 입력하면 규정서식의 '명세' 칸으로 자동 조합합니다.",
    (
        Column("기계번호", "동력기계 번호", "도면(P&ID)에 붙은 기계 기호입니다. (예시) P-101"),
        Column("기계명", "동력기계명", "기계의 이름입니다. (예시) 원료 이송펌프, 반응기 교반기, 호이스트"),
        Column("기계종류", "기계종류", "펌프·압축기·교반기·양중기 등 종류를 적습니다. (예시) 원심펌프", required=False),
        Column("처리량", "시간당 처리량", "펌프·압축기의 시간당 처리량입니다. 단위를 포함합니다. (예시) 20 m3/h", required=False),
        Column("토출압력", "토출측 압력", "펌프·압축기의 토출측 압력입니다. (예시) 0.5 MPa", required=False),
        Column("회전수", "분당 회전수", "펌프·압축기·교반기의 회전수입니다. (예시) 1,750 rpm", required=False),
        Column("임펠러반경", "임펠러 반경", "교반기 임펠러의 반경입니다. 단위를 포함합니다.", required=False),
        Column("양중하중", "양중 가능 무게", "양중기의 최대 양중하중입니다. 단위를 포함합니다.", required=False),
        Column("양중높이", "양중 높이", "양중기의 양중 높이입니다. 단위를 포함합니다.", required=False),
        Column("명세", "명세(직접입력)", "특수 기계 등 자동 조합이 어려울 때 규정서식에 들어갈 명세를 직접 적습니다.", required=False),
        Column("주요재질", "주요재질", "재질분류기호로 확인합니다. (예시) SUS316, SS400, SCS13"),
