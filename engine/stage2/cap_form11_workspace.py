...
COLUMNS: tuple[tuple[str, str, str, str], ...] = (
    ("감지기 번호", "구분기호", "text", "고정식 유해감지시설의 고유 식별번호입니다(서식 주 ①). (예시) GD-001"),
    ...
    ("작동시간", "작동시간", "text", "제조사 사양서의 응답(작동) 시간입니다. 수치와 단위를 함께 적습니다. (예시) 30초 이내"),
    ("측정방식", "측정방식", "choice", "센서의 측정 원리입니다. 고정식·휴대식은 측정방식이 아니라 설치형태입니다."),
    ("경보 설정값", "경보 설정값", "text", "경보가 울리는 농도입니다. 수치와 단위를 함께 적습니다. (예시) 0.5 ppm, 10% LEL"),
    ...
    ("정밀도", "정밀도", "text", "제조사 사양서의 정밀도(정확도)입니다. (예시) ±3% F.S."),
    ("유지관리", "유지관리", "text", "점검·교정 주기입니다. (예시) 월 1회 점검, 6개월 교정"),
