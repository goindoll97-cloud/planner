...
TABLE_SPECS: tuple[dict[str, Any], ...] = (
    {
        ...
        "example": (
            (
                ...
                "경구: LD50 회사 SDS 제11항 / 경피: LD50 회사 SDS 제11항 / 흡입: LC50 회사 SDS 제11항", "4 ℃", "480 ℃", "해당 없음",
    ...
    },
    {
        ...
        "headers": (
            ...
            "주소·위치", "좌표", "사업장 경계와 거리(m)",
            "검색결과 거리(주소점 기준, 참고)", "검색 출처·검색일", "GIS/현장 근거",
            "500m 범위 전체 확인", "비고",
        ),
        "example": (
            ("아니오", "○○초등학교", "갑종", "교육·연구시설",
             "○○시 ○○로 10", "35.0,129.0", 420, "", "", "지도/GIS 확인 자료 및 일자", "예",
             "500m 전체 검토 완료 예시"),
        ),
    },
    {
