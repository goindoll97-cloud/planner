...
TABLE_EXAMPLES: dict[str, tuple[tuple[Any, ...], ...]] = {
    ...
    "10_동력기계": (
        ("P-101", "원료 이송펌프", "원심펌프", "20 m3/h", "7.5 kW", "SUS304", "커플링 가드·모터 과부하 보호", "톨루엔", "원료저장", "PID-101", "펌프 예시"),
        ("C-201", "공정 압축기", "왕복동압축기", "500 Nm3/h", "55 kW", "Carbon Steel", "압력·온도 인터록 및 가드", "공정가스", "압축", "PID-202", "압축기 예시"),
        ("AG-301", "혼합조 교반기", "교반기", "120 rpm", "15 kW", "SUS316L", "회전부 가드·과부하 보호", "혼합액", "혼합", "PID-301", "교반기 예시"),
    ),
    "11_배관_개스킷": (
