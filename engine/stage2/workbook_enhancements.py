...
TABLE_EXAMPLES: dict[str, tuple[tuple[Any, ...], ...]] = {
    "02_화학물질정보": (
        (
            ...
            "0.87", "1.2 vol%", "7.1 vol%", "TWA 50 ppm", "회사 SDS 확인값", "4 ℃", "480 ℃", "해당 없음",
        ...
        (
            ...
            "2.49 (공기=1)", "해당 없음", "해당 없음", "TWA 0.5 ppm", "회사 SDS 확인값", "해당 없음", "해당 없음", "해당 없음",
            "급성독성(흡입)", "구분 2", "ERPG-2 3 ppm", "TWA 0.5 ppm", "기체", "예",
            "chlorine_company_SDS.pdf", "2026-05-10", "독성가스 SDS 확인 예시"
        ),
        (
            "황산", "7664-93-9", "H2SO4", 98, "액체", 8, "m³", "1 m³/day", "폐수처리", "pH 조정제",
            "1.84", "해당 없음", "해당 없음", "TWA 0.2 mg/m³", "회사 SDS 확인값", "해당 없음", "해당 없음", "예",
        ...
        (
            ...
            "0.79", "2.5 vol%", "12.8 vol%", "TWA 500 ppm", "회사 SDS 확인값", "-20 ℃", "465 ℃", "해당 없음",
