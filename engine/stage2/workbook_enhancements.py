...
TABLE_EXAMPLES: dict[str, tuple[tuple[Any, ...], ...]] = {
    "02_화학물질정보": (
        (
            "톨루엔", "108-88-3", 99.5, "액체", 15000, "kg", "원료저장", "원료",
        ...
        (
            "염소", "7782-50-5", 99.9, "기체", 2.5, "ton", "원료저장", "원료",
            "2.49 (공기=1)", "해당 없음", "해당 없음", "급성독성(흡입)", "구분 2",
            "ERPG-2 3 ppm", "TWA 0.5 ppm", "기체", "예",
            "chlorine_company_SDS.pdf", "2026-05-10", "독성가스 SDS 확인 예시"
        ),
        (
            "황산", "7664-93-9", 98, "액체", 8, "m³", "폐수처리", "pH 조정제",
            "1.84", "해당 없음", "해당 없음", "피부부식성", "구분 1A",
            "자료 없음", "TWA 0.2 mg/m³", "자료 없음", "예",
            "sulfuric_acid_company_SDS.pdf", "2026-04-15", "부식성 액체 SDS 확인 예시"
        ),
        (
            "아세톤", "67-64-1", 99, "액체", 2000, "L", "세정", "세정제",
            "0.79", "2.5 vol%", "12.8 vol%", "특정표적장기독성(1회)", "구분 3",
            "자료 없음", "TWA 500 ppm", "231 mmHg (25℃)", "해당 없음",
            "acetone_company_SDS.pdf", "2026-03-20", "세정·회수 공정 SDS 확인 예시"
        ),
    ),
    "03_설비정보": (
        ("TK-101", "톨루엔 저장탱크", "저장탱크", "원료저장", "톨루엔", 20, "m³", "0.49 MPa", "80 ℃", "0.15 MPa", "30 ℃", "SUS304", 15000, "PID-101", "저장설비 예시", 50),
        ("R-201", "합성 반응기", "반응기", "반응", "원료 A/B", 5, "m³", "1.0 MPa", "150 ℃", "0.45 MPa", "95 ℃", "SUS316L", 3200, "PID-201", "반응설비 예시", 40),
        ("P-301", "제품 이송펌프", "펌프", "이송", "제품", 25, "m³/h", "0.8 MPa", "60 ℃", "0.4 MPa", "35 ℃", "SUS304", "", "PID-301", "동력기계도 설비목록에 연결 가능", 25),
        ("E-401", "공정 열교환기", "열교환기", "냉각", "공정유체", 120, "m²", "1.2 MPa", "180 ℃", "0.5 MPa", "90 ℃", "SUS316L", "", "PID-401", "열교환기 예시", 32),
        ("V-501", "중간제품 압력용기", "압력용기", "분리", "중간제품", 3, "m³", "1.5 MPa", "120 ℃", "0.7 MPa", "70 ℃", "SUS304", 1800, "PID-501", "압력용기 예시", 32),
    ),
    "04_안전밸브_파열판": (
