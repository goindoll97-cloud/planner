...
TABLE_EXAMPLES: dict[str, tuple[tuple[Any, ...], ...]] = {
    ...
    "03_설비정보": (
        ("TK-101", "톨루엔 저장탱크", "저장탱크", "원료저장", "톨루엔", 20, "m³", "0.49 MPa", "80 ℃", "0.15 MPa", "30 ℃", "SUS304", "SUS304", "PTFE", "1.0", "6 mm", "1 mm", "8 mm", "해당 없음", "10%", 15000, "PID-101", "저장설비 예시", 50),
        ("R-201", "합성 반응기", "반응기", "반응", "원료 A/B", 5, "m³", "1.0 MPa", "150 ℃", "0.45 MPa", "95 ℃", "SUS316L", "SUS316L", "Spiral Wound", "1.0", "8 mm", "1 mm", "10 mm", "해당 없음", "20%", 3200, "PID-201", "반응설비 예시", 40),
        ("P-301", "제품 이송펌프", "펌프", "이송", "제품", 25, "m³/h", "0.8 MPa", "60 ℃", "0.4 MPa", "35 ℃", "SUS304", "SUS304", "PTFE", "해당 없음", "해당 없음", "해당 없음", "해당 없음", "해당 없음", "해당 없음", "", "PID-301", "동력기계도 설비목록에 연결 가능", 25),
        ("E-401", "공정 열교환기", "열교환기", "냉각", "공정유체", 120, "m²", "1.2 MPa", "180 ℃", "0.5 MPa", "90 ℃", "SUS316L", "SUS316L", "Spiral Wound", "1.0", "7 mm", "1 mm", "9 mm", "해당 없음", "10%", "", "PID-401", "열교환기 예시", 32),
        ("V-501", "중간제품 압력용기", "압력용기", "분리", "중간제품", 3, "m³", "1.5 MPa", "120 ℃", "0.7 MPa", "70 ℃", "SUS304", "SUS304", "Spiral Wound", "1.0", "8 mm", "1 mm", "10 mm", "해당 없음", "20%", 1800, "PID-501", "압력용기 예시", 32),
    ),
    "04_안전밸브_파열판": (
