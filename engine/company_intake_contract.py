...
COMPANY_FACT_SPECS: tuple[CompanyFactSpec, ...] = (
    ...
    CompanyFactSpec("사업장관리번호", "12345678901 (가상)", "대상 시", "공정안전보고서", "근로복지공단 등에서 부여된 사업장관리번호. 모르면 '모름'으로 두고 제출 전에 확인", ("business.workplace_management_no",)),
...
def seed_company_facts(project: Any, business: Mapping[str, object]) -> None:
    ...
    labels_by_key = {
        ...
        "business.workplace_management_no": "사업장관리번호",
