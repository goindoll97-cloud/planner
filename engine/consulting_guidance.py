...
GUIDES: dict[str, ConsultingGuide] = {
    ...
    "CAP_FINAL_GROUP": ConsultingGuide(
        ...
        decision_effect="법 제23조제1항 단서에 해당하지 않고 최대보유량이 규정수량 기준에 해당하면 작성수준을 1군 또는 2군으로 확인합니다. 1군 요건의 일부 사실이 불명확하면 작성 필요성은 유지하되 작성수준만 판정보류합니다.",
    ),
    ...
    "DECISION_HOLD": ConsultingGuide(
        ...
        what_to_check=("함량·순도", "최대보유량", "SDS 분류", "시설 유형·법 제23조제1항 단서 해당 여부", "법령·승인 DB 최신상태"),
