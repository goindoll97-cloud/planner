...
GUIDES: dict[str, ConsultingGuide] = {
    "PSM_R_RATIO": ConsultingGuide(
        ...
        example="R=1.20이면 현재 확인된 수량기준 합계가 기준의 120%라는 뜻입니다. 다만 이것만으로 최종 PSM 대상이 확정되지는 않습니다.",
    ...
    "PSM_EXCLUDED_FACILITY": ConsultingGuide(
        ...
        plain_language="수량기준에 걸리더라도 법에서 PSM 적용대상에서 제외하도록 정한 특정 종류의 설비가 있습니다.",
    ...
    "CAP_EXEMPTIONS": ConsultingGuide(
        ...
        why_needed="수량기준만 보고 작성대상으로 확정하면 법정 면제시설을 놓칠 수 있기 때문입니다.",
        what_to_check=(
