...
PSM Annex 13 and CAP Appendices 1/2/3/4 each use dedicated parsers validated
against their current monitored official PDFs. Candidate extraction never
equals legal approval; an administrator must review before the table becomes
decision data.
"""

from __future__ import annotations

from .cap_app1_parser import build_cap_appendix1_candidate
...
from .cap_app4_parser import build_cap_appendix4_candidate
